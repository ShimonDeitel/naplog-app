...
final class Store: ObservableObject {
    ...
    private let fileName = "naplog_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Nap One", detail: "First example entry.", date: now),
            Entry(title: "Sample Nap Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Nap Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
