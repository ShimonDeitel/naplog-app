        ...
        NavigationStack {
            ...
            .overlay {
                if store.entries.isEmpty {
                    ContentUnavailableView("No Naps Yet", systemImage: "tray", description: Text("Tap + to add your first entry."))
                }
            }
        ...
        NavigationStack {
            Form {
                Section("Nap") {
                    ...
                    TextField("Details (duration (min))", text: $detail)
                    DatePicker("Date", selection: $date, displayedComponents: .date)
                }
            }
            .navigationTitle(entry == nil ? "Add Nap" : "Edit Nap")
            .toolbar {
